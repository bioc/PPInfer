...
<<eval=FALSE>>=
############################## E. coli
string.db.511145 <- STRINGdb$new(species = 511145)
...
############################## yeast
# string.db.4932 <- STRINGdb$new(species = 4932)
...
############################## C. elegans
# string.db.6239 <- STRINGdb$new(species = 6239)
...
# string.db.7227 <- STRINGdb$new(species = 7227)
...
# string.db.3702 <- STRINGdb$new(species = 3702)
...
############################## Zebra fish
# string.db.7955 <- STRINGdb$new(species = 7955)
